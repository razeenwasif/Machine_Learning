...
def tokenise_document(text):
    ...
    # TODO: Tokenise the text and return a list of sentences
    #       where each sentence is a list of tokens.
    # Hint: First use nltk.tokenize.sent_tokenize() to split
    #       a document (represented as a string) into 
    #       sentences (represented as a list of strings).
...
if __name__ == '__main__':
    ...
    # TODO: Specify the name (and the path if the file is not in your current 
    # directory) of the word2vec model file you are using. 
    ...
    # word_vectors = Word2Vec.load(model_file).wv
